...
public class ServerRecord extends Object
{
   ...
   {  return this.ipAddress + " " + this.hostname + " " + this.when.toString()
            + " " + this.cmd + " " + this.url + " " + this.completeCode + " "
            + this.size;
   }
   ...
   /** Does the URL contain the given string? */
   public boolean URLContains(String search)
   {  return this.url.indexOf(search) >= 0;
   }
