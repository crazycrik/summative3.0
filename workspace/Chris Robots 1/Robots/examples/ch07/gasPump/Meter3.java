...
public class Meter3 extends Object
{
   ...
   *  @param theLabel A label for the fuel such as "Gold" or "Ultra". */
   public Meter3(double unitCost, int octaneRating, 
                     String theLabel)
   {  super();
   ...
   *  @return price/unit * number of units sold */
   ...
   {  Test tester = new Test();
      Meter3 m1 = new Meter3(1.109, 87, "Regular");
      ...
      Meter3 m2 = new Meter3(1.149, 89, "Ultra");
